...
<title>Add Security Details</title>
<link rel="stylesheet"
...
<body>
	<div class="container" style="margin-top: 10%;">
		<form class="form-horizontal" role="form" action="AddSecurityController"
			method="post">
			<h2>Add Member</h2>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" id="password" placeholder="Number" name="age"
			...
			<div class="form-group">
				<div class="col-sm-9 col-sm-offset-3">
					<button type="submit" value="addsecurity"
						class="btn btn-primary btn-block">Add Security</button>
				</div>
			</div>
		</form>
	</div>

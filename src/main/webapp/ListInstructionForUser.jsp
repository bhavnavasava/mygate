...
<title>List Instruction for user</title>
<link rel="stylesheet"
...
<body>
	...
	<%
	ArrayList<InstructionBean> instructionsForUser = (ArrayList<InstructionBean>) request.getAttribute("instructionsForUser");
	%>
		...
		<div class="row">
			...
			<div class="col-md-8">
				<table class="display" id="users">
					...
					<tbody>
						<%
						for (InstructionBean instruction : instructionsForUser) {
						%>
						<tr>
							<td><%=instruction.getInstructionid()%></td>
							...
							<td><a
								href="DeleteInstructionForUserController?instructionid=<%=instruction.getInstructionid()%>">Delete</a></td>

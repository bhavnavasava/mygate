					...
					<div class="tab-content">
						<div id="home" class="tab-pane fade in active">
							...
							<form action="ForgetPasswordController" method="post">
								...
								<div class="form-group">
									<label for="pwd">contact Number:</label> <input
										type="contactnumber" class="form-control" id="pwd"
										placeholder="password" name="contactnumber">
								</div>
							...
							<br /> <a href="Login.jsp 	"
								class="pull-right btn btn-block btn-primary">Back To Login </a>
							<span class="text-danger">${errorMsg}</span> ${error} ${message}
						</div>
					</div>
				</div>
			</div>
